...
> = {
  ...
  success: {
    ...
    textColor: "text-[#062E20]",
    textShadow: "[text-shadow:_0_1px_0_rgb(255_255_255_/_45%)]",
  },
  error: {
    outer: "bg-gradient-to-b from-[#5A0000] to-[#FFAEB0]",
    inner: "bg-gradient-to-b from-[#FFDEDE] via-[#680002] to-[#FFE9E9]",
    button: "bg-gradient-to-b from-[#F08D8F] to-[#A45253]",
    textColor: "text-[#3E090A]",
    textShadow: "[text-shadow:_0_1px_0_rgb(255_255_255_/_38%)]",
  },
  gold: {
    outer: "bg-gradient-to-b from-[#917100] to-[#EAD98F]",
    inner: "bg-gradient-to-b from-[#FFFDDD] via-[#856807] to-[#FFF1B3]",
    button: "bg-gradient-to-b from-[#FFEBA1] to-[#9B873F]",
    textColor: "text-[#2B2108]",
    textShadow: "[text-shadow:_0_1px_0_rgb(255_255_255_/_45%)]",
  },
  bronze: {
    ...
    textColor: "text-[#2B1608]",
    textShadow: "[text-shadow:_0_1px_0_rgb(255_255_255_/_42%)]",
  },
};
