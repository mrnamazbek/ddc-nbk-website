...
export default function CTA() {
  ...
  return (
    <section className="relative w-full py-24 sm:py-32 bg-[#08080a] overflow-hidden border-t border-white/5">
      {/* Анимированный фоновый градиент (мягкие переливы в сине-голубом стиле ЦЦР) */}
      <div className="absolute inset-0 bg-radial-[at_50%_50%] from-[#002d62]/30 via-[#08080a] to-[#08080a] opacity-60 pointer-events-none" />
      
      {/* Декоративные вращающиеся круги на фоне */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-brand-blue-light/5 animate-[spin_60s_linear_infinite] pointer-events-none" />
      ...
      <div className="max-w-5xl mx-auto px-6 sm:px-12 lg:px-16 relative z-10 text-center">
        ...
        >
          ...
          >
            ...
            <div className="absolute -top-40 -left-40 w-80 h-80 bg-brand-blue/20 rounded-full blur-[80px] pointer-events-none" />
