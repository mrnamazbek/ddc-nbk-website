...
export default function Hero() {
  ...
  return (
    <section 
      ref={containerRef}
      className="relative w-full min-h-screen lg:h-screen lg:max-h-[800px] xl:max-h-[900px] flex flex-col justify-center items-start overflow-hidden bg-transparent pt-20"
    >
      ...
      >
        ...
        >
          ...
          <motion.p
            ...
            className="text-base sm:text-lg text-foreground/70 font-sans font-light leading-relaxed max-w-2xl mb-6"
          >
            {t("subtitle")}
          </motion.p>
        ...
        <motion.div
          ...
          className="absolute top-1/2 right-0 -translate-y-1/2 w-full md:w-[50%] lg:w-[45%] h-[80%] md:h-[95%] pointer-events-none z-1 overflow-visible opacity-55 md:opacity-85 mix-blend-screen"
        >
